...
Misc notes on setting up a development environment. Rarely needs to be done, but wanted to document my personal setup.
  ...
  1) Use this SCSS bundle. Uses nokigiri which is in Gemfile - https://github.com/kuroir/SCSS.tmbundle
...
All blog content and images are Copyright (c) 2006-2011, Ken Collins. Use is strictly forbidden unless consent is given. Only jekyll plugins and helpers are MIT Licensed. 
